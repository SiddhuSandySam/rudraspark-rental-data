/**
 * RUDRASPARK RENTAL SMART DATA SYNC ROBOT (V4.2 - RETRY & RESILIENT TIMEOUT ENHANCED)
...
async function startRobotSync() {
    ...
    const hubResp = await fetchWithRetry(`${RENTAL_HUB_URL}?type=app_data&nocache=true`);
